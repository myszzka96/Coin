...
{
  /* the problem has 4 variables, x[0] through x[3] */ 
  n=4;

  /* two constraints: one equality and one inequality */
  m=2;

  /* the Jacobian of the constraints g(x) */
  /* In this example, the Jacobian is dense and contains 8 nonzeros */
  nnz_jac_g=8;

  /* the Hessian of the Lagrangian */
  /* the Hessian is also dense and has 16 total nonzeros, */
  /* but we only need the lower left corner, since it is symmetric */
  nnz_h_lag=10;
                            ...
                            Index m, Number* g_l, Number* g_u)
{
  ...
  /* the g1 has no upper bound, here we set it to 2e18 */
  g_l[0] = 25;
  g_u[0] = 2e19;

  /* the second constraint g2 is an equality constraint, */
  /* so we set the upper and lower bound to the same value */
  g_l[1] = g_u[1] = 40.0;
